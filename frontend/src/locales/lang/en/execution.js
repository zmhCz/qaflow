export default {
  ...
  selectProjectBeforeOpenTestcases:
    "Please select related project(s) before selecting test cases",
  batchDeleteConfirm:
    "Are you sure to delete selected {count} test plans? This action cannot be undone.",
  batchDeleteCasesConfirm:
    "Are you sure to delete selected {count} cases? This action cannot be undone.",
  ...
  batchDeletePartialSuccess:
    "Successfully deleted {successCount} test plans, {failCount} failed",
  batchDeleteCasesPartialSuccess:
    "Successfully deleted {successCount} cases, {failCount} failed",
