  ...
  >
    <div class="data-factory-selector">
      <el-tabs v-model="activeTab" @tab-change="handleTabChange">
        <el-tab-pane
          :label="t('apiTesting.dataFactory.select.byTag')"
          name="byTag"
        >
          <div class="tag-selector">
            <el-form :inline="true" @submit.prevent="fetchRecordsByTag">
              ...
              <el-form-item
                :label="t('apiTesting.dataFactory.select.toolCategory')"
              >
                <el-select
                  v-model="filterCategory"
                  :placeholder="
                    t('apiTesting.dataFactory.select.selectToolCategory')
                  "
                  clearable
                  style="width: 200px"
                >
              ...
              <el-form-item>
                <el-button type="primary" @click="fetchRecordsByTag">{{
                  t("apiTesting.dataFactory.select.search")
                }}</el-button>
              </el-form-item>
            </el-form>
            ...
            >
              ...
              <el-table-column
                prop="tool_name_display"
                :label="t('apiTesting.dataFactory.select.toolName')"
                min-width="150"
              />
              <el-table-column
                prop="tool_category_display"
                :label="t('apiTesting.dataFactory.select.category')"
                min-width="100"
              />
              <el-table-column
                prop="created_at"
                :label="t('apiTesting.dataFactory.select.createdAt')"
                min-width="180"
              >
              ...
              <el-table-column
                prop="tags"
                :label="t('apiTesting.dataFactory.select.tags')"
                min-width="150"
              >
                <template #default="{ row }">
                  <el-tag
              ...
              <el-table-column
                :label="t('apiTesting.dataFactory.select.operation')"
                width="150"
                fixed="right"
              >
                <template #default="{ row }">
        ...
        <el-tab-pane
          :label="t('apiTesting.dataFactory.select.byRecord')"
          name="byRecord"
        >
            ...
            <el-form :inline="true" @submit.prevent="fetchRecords">
              ...
              >
                <el-input
                  ...
                  :placeholder="
                    t('apiTesting.dataFactory.select.inputToolName')
                  "
                  clearable
                  @clear="fetchRecords"
                />
    ...
    <template #footer>
      <el-button @click="handleClose">{{
        t("apiTesting.dataFactory.select.cancel")
      }}</el-button>
      <el-button
        type="primary"
        @click="handleConfirm"
  ...
  >
    <div v-if="previewRecordData" class="preview-content">
      <el-descriptions :column="1" border>
        ...
        <el-descriptions-item
          :label="t('apiTesting.dataFactory.select.inputData')"
        >
          <pre class="json-preview">{{
            JSON.stringify(previewRecordData.input_data, null, 2)
          }}</pre>
        </el-descriptions-item>
        <el-descriptions-item
          :label="t('apiTesting.dataFactory.select.outputData')"
        >
          <pre class="json-preview">{{
            JSON.stringify(previewRecordData.output_data, null, 2)
          }}</pre>
        </el-descriptions-item>
      </el-descriptions>
    </div>
