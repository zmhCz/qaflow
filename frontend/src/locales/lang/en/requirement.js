export default {
  requirementAnalysis: {
    ...
    xmindRootTitle: "AI Generated Test Cases",
    xmindDownloadSuccess: "XMind downloaded successfully",
    xmindDownloadFailed: "XMind download failed",
  ...
  promptConfig: {
    ...
    promptExists:
      "The following prompts already exist: {types}. Please do not load or add duplicates",
