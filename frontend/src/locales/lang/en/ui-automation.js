export default {
  ...
  element: {
    ...
    rules: {
      ...
      locatorLength:
        "Locator expression length should be between 1 and 500 characters",
    },
    messages: {
  ...
  notification: {
    ...
    configs: {
      ...
      signatureSecretPlaceholder:
        "Please enter DingTalk robot signature secret (optional)",
      signatureSecretHint:
        'DingTalk robot signature secret for security verification. Fill this if the robot has enabled "Sign" security setting.',
      // Tab labels
  ...
  testCase: {
    ...
    run: {
      start:
        "Starting test case - {engine} engine / {browser} browser / {mode} mode",
    ...
    variables: {
      ...
      randomIntDesc:
        "Generate random integer in specified range, params: min, max, count",
      randomFloat: "Generate random float",
      randomFloatDesc:
        "Generate random float in specified range, params: min, max, precision, count",
      randomDigits: "Generate random digit string",
      randomString: "Generate random alphanumeric string",
      randomStringDesc:
        "Generate random string, params: length, char_type(all/letter/number), count",
