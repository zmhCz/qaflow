  ...
  <div class="page-container">
    ...
    <div class="card-container">
      ...
      <el-table :data="cases" v-loading="loading" style="width: 100%">
        <el-table-column
          prop="name"
          :label="$t('uiAutomation.ai.caseList.caseName')"
          min-width="200"
        ...
        <el-table-column
          ...
          :label="$t('uiAutomation.ai.caseList.taskDescription')"
          min-width="300"
          show-overflow-tooltip
        />
        <el-table-column
    ...
    <el-dialog
      ...
      :title="$t('uiAutomation.ai.caseList.editCase')"
      width="600px"
...
const formRules = computed(() => ({
  ...
  task_description: [
    {
      required: true,
      message: t("uiAutomation.ai.caseList.rules.taskDescriptionRequired"),
      trigger: "blur",
    },
  ],
}));
