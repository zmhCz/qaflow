  ...
  <div class="notification-logs">
    ...
    >
      ...
      <el-table-column label="通知类型" width="120">
        <template #default="{ row }">
          <el-tag
            :type="getNotificationTypeTag(row.actual_notification_type_display)"
            size="small"
          >
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="任务名称"
              ><span>{{ selectedLog.task_name }}</span></el-form-item
            >
          </el-col>
          <el-col :span="12">
            <el-form-item label="任务类型"
              ><span>{{ selectedLog.task_type_display }}</span></el-form-item
            >
          </el-col>
          <el-col :span="12">
          ...
          >
            <el-form-item label="Webhook机器人">
              <el-tag size="small" type="info">{{
                selectedLog.webhook_bot_info.name || "默认机器人"
              }}</el-tag>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="通知内容">
              <div class="content-box">
                ...
                <pre v-else class="raw-content">{{
                  selectedLog.notification_content || "-"
                }}</pre>
              </div>
            </el-form-item>
          </el-col>
...
const parsedContent = computed(() => {
  ...
  try {
    ...
    else if (json.card?.elements?.[0]?.text?.content)
