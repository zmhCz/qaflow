    ...
    <div class="content">
      <el-table :data="reports" v-loading="loading" style="width: 100%">
        ...
        <el-table-column
          ...
          :label="$t('apiTesting.report.testSuite')"
          min-width="200"
        />
        <el-table-column
          prop="status"
        ...
        <el-table-column
          prop="total_requests"
          :label="$t('apiTesting.report.totalRequests')"
          width="100"
        />
        <el-table-column
          prop="passed_requests"
          :label="$t('apiTesting.report.passedCount')"
          width="100"
        >
          <template #default="scope">
        ...
        <el-table-column
          ...
          :label="$t('apiTesting.report.failedCount')"
          width="100"
        >
          <template #default="scope">
        ...
        <el-table-column
          ...
          :label="$t('apiTesting.report.executor')"
          width="120"
        />
        <el-table-column
          prop="created_at"
          :label="$t('apiTesting.report.executionTime')"
          width="180"
        >
          <template #default="scope">
        ...
        <el-table-column :label="$t('apiTesting.common.operation')" width="150">
          <template #default="scope">
            <el-button
              ...
              >{{ $t("apiTesting.report.generateAndViewReport") }}</el-button
            >
          </template>
        </el-table-column>
      </el-table>
...
const generateAndOpenAllureReport = async (executionId) => {
  try {
    ...
    const response = await api.post(
      `/api-testing/test-executions/${executionId}/generate-allure-report/`,
    );
