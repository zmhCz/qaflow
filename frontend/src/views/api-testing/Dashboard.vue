  ...
  <div class="dashboard-container">
            ...
            <div class="stat-content">
              ...
              <div class="stat-info">
                ...
                <div class="stat-label">
                  {{ $t("apiTesting.dashboard.apiProjects") }}
                </div>
              </div>
            </div>
          </el-card>
          ...
          <el-card shadow="hover" class="stat-card">
            <div class="stat-content">
              ...
              <div class="stat-info">
                ...
                <div class="stat-label">
                  {{ $t("apiTesting.dashboard.interfaceCount") }}
                </div>
              </div>
            </div>
          </el-card>
          ...
          <el-card shadow="hover" class="stat-card">
            <div class="stat-content">
              ...
              <div class="stat-info">
                ...
                <div class="stat-label">
                  {{ $t("apiTesting.dashboard.testSuites") }}
                </div>
              </div>
            </div>
          </el-card>
          ...
          <el-card shadow="hover" class="stat-card">
            <div class="stat-content">
              ...
              <div class="stat-info">
                ...
                <div class="stat-label">
                  {{ $t("apiTesting.dashboard.executionRecords") }}
                </div>
              </div>
            </div>
          </el-card>
    ...
    <el-row :gutter="20" class="content-section">
          ...
          <div v-else class="activities-list">
            ...
            >
              <div class="activity-icon">
                <el-icon v-if="log.operation_type === 'create'" color="#52c41a"
                  ><Plus
                /></el-icon>
                <el-icon
                  v-else-if="log.operation_type === 'edit'"
                  color="#1890ff"
                  ><Edit
                /></el-icon>
                <el-icon
                  v-else-if="log.operation_type === 'delete'"
                  color="#ff4d4f"
                  ><Delete
                /></el-icon>
                <el-icon
                  v-else-if="log.operation_type === 'execute'"
                  color="#722ed1"
                  ><VideoPlay
                /></el-icon>
              ...
              <div class="activity-content">
                ...
                <div class="activity-meta">
                  <span class="activity-user">{{
                    log.user_name || $t("apiTesting.dashboard.system")
                  }}</span>
      ...
      <el-col :span="12">
        <el-card
          class="quick-actions"
          :title="$t('apiTesting.dashboard.quickActions.title')"
          shadow="hover"
        >
          <div class="actions-grid">
            <div class="action-item" @click="goToProjects">
              ...
              <div class="action-label">
                {{ $t("apiTesting.dashboard.quickActions.projectManagement") }}
              </div>
            </div>
            <div class="action-item" @click="goToInterfaces">
              ...
              <div class="action-label">
                {{
                  $t("apiTesting.dashboard.quickActions.interfaceManagement")
                }}
              </div>
            </div>
            <div class="action-item" @click="goToAutomation">
              ...
              <div class="action-label">
                {{ $t("apiTesting.dashboard.quickActions.automationTesting") }}
              </div>
            </div>
            <div class="action-item" @click="goToHistory">
              ...
              <div class="action-label">
                {{ $t("apiTesting.dashboard.quickActions.requestHistory") }}
              </div>
            </div>
            <div class="action-item" @click="goToEnvironments">
              ...
              <div class="action-label">
                {{
                  $t("apiTesting.dashboard.quickActions.environmentManagement")
                }}
              </div>
            </div>
            <div class="action-item" @click="goToReports">
              ...
              <div class="action-label">
                {{ $t("apiTesting.dashboard.quickActions.testReport") }}
              </div>
            </div>
          </div>
        </el-card>
    ...
    <div class="features-section">
      <h2 class="section-title">
        {{ $t("apiTesting.dashboard.coreFeatures") }}
      </h2>
      <el-row :gutter="20">
        <el-col :span="6">
          <el-card shadow="hover" class="feature-card">
            ...
            <h3 class="feature-title">
              {{
                $t("apiTesting.dashboard.features.interfaceManagement.title")
              }}
            </h3>
            <p class="feature-description">
              {{
                $t(
                  "apiTesting.dashboard.features.interfaceManagement.description",
                )
              }}
            </p>
          </el-card>
        ...
        <el-col :span="6">
          <el-card shadow="hover" class="feature-card">
            ...
            <h3 class="feature-title">
              {{ $t("apiTesting.dashboard.features.automationTesting.title") }}
            </h3>
            <p class="feature-description">
              {{
                $t(
                  "apiTesting.dashboard.features.automationTesting.description",
                )
              }}
            </p>
          </el-card>
        ...
        <el-col :span="6">
          <el-card shadow="hover" class="feature-card">
            ...
            <h3 class="feature-title">
              {{ $t("apiTesting.dashboard.features.scheduledTask.title") }}
            </h3>
            <p class="feature-description">
              {{
                $t("apiTesting.dashboard.features.scheduledTask.description")
              }}
            </p>
          </el-card>
        </el-col>
        <el-col :span="6">
          <el-card shadow="hover" class="feature-card">
            ...
            <h3 class="feature-title">
              {{
                $t("apiTesting.dashboard.features.multiDimensionalReport.title")
              }}
            </h3>
            <p class="feature-description">
              {{
                $t(
                  "apiTesting.dashboard.features.multiDimensionalReport.description",
                )
              }}
            </p>
          </el-card>
...
const formatTime = (timeStr) => {
  ...
  // 小于1小时
  if (diff < 3600000) {
    return t("apiTesting.dashboard.timeFormat.minutesAgo", {
      n: Math.floor(diff / 60000),
    });
  }
  // 小于1天
  if (diff < 86400000) {
    return t("apiTesting.dashboard.timeFormat.hoursAgo", {
      n: Math.floor(diff / 3600000),
    });
  }
  // 小于7天
  if (diff < 604800000) {
    return t("apiTesting.dashboard.timeFormat.daysAgo", {
