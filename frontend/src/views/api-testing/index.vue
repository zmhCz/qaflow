    ...
    <div class="top-nav">
      ...
      >
        <el-menu-item index="projects">{{
          $t("apiTesting.nav.projects")
        }}</el-menu-item>
        <el-menu-item index="interfaces">{{
          $t("apiTesting.nav.interfaces")
        }}</el-menu-item>
        <el-menu-item index="automation">{{
          $t("apiTesting.nav.automation")
        }}</el-menu-item>
        <el-menu-item index="history">{{
          $t("apiTesting.nav.history")
        }}</el-menu-item>
        <el-menu-item index="environments">{{
          $t("apiTesting.nav.environments")
        }}</el-menu-item>
        <el-menu-item index="scheduled-tasks">{{
          $t("apiTesting.nav.scheduledTasks")
        }}</el-menu-item>
        <el-menu-item index="reports">{{
          $t("apiTesting.nav.reports")
        }}</el-menu-item>
        <el-menu-item index="notification-logs">{{
          $t("apiTesting.nav.notificationLogs")
        }}</el-menu-item>
        <el-menu-item index="notification-configs">{{
          $t("apiTesting.nav.notificationConfigs")
        }}</el-menu-item>
      </el-menu>
    </div>
