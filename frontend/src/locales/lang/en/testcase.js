export default {
  testcase: {
    ...
    batchDeleteConfirm:
      "Are you sure to delete selected {count} test cases? This action cannot be undone.",
    batchDeleteSuccess: "Successfully deleted {successCount} test cases",
    batchDeletePartialSuccess:
      "Successfully deleted {successCount} test cases, {failCount} failed",
    ...
    importCreated:
      "Import task created. Please check the import records for progress",
